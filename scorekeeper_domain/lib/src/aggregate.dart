...
/// Is NOT generated and referenced in domain protobuf files,
/// since there it is supposed to be contained as 2 separate fields
...
class AggregateId {
  ...
  AggregateId.random(this.type) : this.id = const Uuid().v4();

  @override
  bool operator ==(Object other) =>
      identical(this, other) || other is AggregateId && runtimeType == other.runtimeType
...
// Voorlopig op deze manier de class doorspelen
// const AggregateId = i.AggregateId;

/// Wrapper class that exposes limited set ???
/// We willen evt die generated shit afschermen, maar dan moeten we dat eigenlijk voor alles doen, sedus...
// class AggregateId {
//   final i.AggregateId _delegate;
//
//   AggregateId.of(String id, Type type) : _delegate = i.AggregateId(uuid: id, type: type.toString());
//
//   AggregateId.random(Type type) : _delegate = i.AggregateId(uuid: const Uuid().v4(), type: type.toString());
//
//   String get id => _delegate.uuid;
//
//   String get type => _delegate.type;
//
//   i.AggregateId get aggregateId => _delegate;
//
//   @override
//   bool operator ==(Object other) =>
//       identical(this, other) || other is AggregateId && runtimeType == other.runtimeType
...
abstract class AggregateDtoFactory {
  ...
  R create<R extends AggregateDto>(Aggregate aggregate);
