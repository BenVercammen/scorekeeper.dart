...
abstract class Aggregate<A extends AggregateId> {
...
/// Abstract class, the actual implementations are to be generated by the actual domain.
...
class AggregateIdType {
  const AggregateIdType(this.idType);
  final Type idType;
}
